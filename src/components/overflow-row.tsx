          ...
          <Popover>
            <Tooltip>
              ...
              tabIndex={controlTabIndex}
                    ...
                    aria-label={title}
                    className="inline-flex size-(--control-h-lg) shrink-0 items-center justify-center rounded-full border text-muted-foreground hover:bg-accent data-[active=true]:border-primary data-[active=true]:bg-primary/10 data-[active=true]:text-foreground"
                  >
