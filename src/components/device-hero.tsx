      ...
      <TooltipTrigger asChild>
        ...
        >
          ...
          {hasBackup === true ? (
            <>
              {meta && (
                <div className="mt-0.5 w-full truncate text-2xs text-sidebar-foreground/60">
                  {meta}
                </div>
              )}
              {deviceInfo?.isEncrypted === true && (
                <span className="mt-2 inline-flex items-center gap-1 rounded-full bg-[var(--accent-soft)] px-2.5 py-0.5 text-2xs font-medium text-[var(--accent-text)]">
            ...
            <>
              <div className="mt-0.5 text-2xs text-sidebar-foreground/60">
                No backup open
              </div>
