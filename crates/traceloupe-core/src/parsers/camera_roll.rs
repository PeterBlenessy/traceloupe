...
/// Measured on a real «redacted»-asset library, «redacted» assets had their original and
/// «redacted» had only a thumbnail. Enumerating files alone therefore shows about a
...
mod tests {
    ...
    /// on a real «redacted»-asset library only «redacted» had one. Enumerating files
