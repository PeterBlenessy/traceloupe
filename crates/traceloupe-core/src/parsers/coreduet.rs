    ...
    fn parses_the_interaction_graph() {
        ...
        conn.execute_batch(
            "CREATE TABLE ZCONTACTS (Z_PK INTEGER PRIMARY KEY, ZDISPLAYNAME TEXT, ZIDENTIFIER TEXT,
             ...
             INSERT INTO ZCONTACTS VALUES (1,'Robin','+15551234567',10,«redacted»692800.«redacted»692900.0,NULL,721700000.«redacted»710000.0,NULL);
             -- an identifier-only contact with interactions.
             INSERT INTO ZCONTACTS VALUES (2,NULL,'a@b.com',3,«redacted»695000.0,NULL,NULL,721696000.0,NULL,NULL);
