    ...
    fn make_sms_db(dir: &Path) -> std::path::PathBuf {
        ...
        conn.execute_batch(
            "CREATE TABLE handle (ROWID INTEGER PRIMARY KEY, id TEXT);
             ...
             INSERT INTO message VALUES (100,'hey there',«redacted»692800000000000,1,0,0,0,'GUID-100',NULL,0,NULL);
             -- outgoing, delivered + read (date_delivered / date_read set).
             INSERT INTO message VALUES (101,'hi back',«redacted»692860000000000,0,«redacted»692900000000000,721692880000000000,'GUID-101',NULL,0,NULL);
             INSERT INTO message VALUES (200,'who is in?',«redacted»700000000000000,2,0,0,0,'GUID-200',NULL,0,NULL);
             -- an attachment-only message (NULL text) is kept.
             INSERT INTO message VALUES (201,NULL,«redacted»700060000000000,0,1,0,0,'GUID-201',NULL,0,NULL);
             -- a pure action item (NULL text, no attachment) is skipped.
             INSERT INTO message VALUES (202,NULL,«redacted»700120000000000,1,0,0,0,'GUID-202',NULL,0,NULL);
             -- a tapback (Loved) on message 100 from the device owner; not a message.
             INSERT INTO message VALUES (300,NULL,«redacted»692900000000000,0,0,0,0,'GUID-300','p:0/GUID-100',2000,NULL);
             INSERT INTO chat_message_join VALUES («redacted»),(«redacted»),(«redacted»),(«redacted»),(«redacted»),(«redacted»);",
        )
        .unwrap();
        db
    }
