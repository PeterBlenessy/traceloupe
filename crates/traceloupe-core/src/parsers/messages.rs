    ...
    fn make_sms_db(dir: &Path) -> std::path::PathBuf {
        ...
        conn.execute_batch(
            "CREATE TABLE handle (ROWID INTEGER PRIMARY KEY, id TEXT);
             ...
             INSERT INTO message VALUES (100,'hey there',«redacted»692800000000000,1,0,0,0,'GUID-100',NULL,0,NULL,NULL);
             -- outgoing, delivered + read (date_delivered / date_read set).
             INSERT INTO message VALUES (101,'hi back',«redacted»692860000000000,0,«redacted»692900000000000,721692880000000000,'GUID-101',NULL,0,NULL,NULL);
             -- an inline reply to message 100 ('hey there').
             INSERT INTO message VALUES (102,'reply body',«redacted»692920000000000,0,0,0,0,'GUID-102',NULL,0,NULL,'p:0/GUID-100');
             INSERT INTO message VALUES (200,'who is in?',«redacted»700000000000000,2,0,0,0,'GUID-200',NULL,0,NULL,NULL);
             -- an attachment-only message (NULL text) is kept.
             INSERT INTO message VALUES (201,NULL,«redacted»700060000000000,0,1,0,0,'GUID-201',NULL,0,NULL,NULL);
             -- a pure action item (NULL text, no attachment) is skipped.
             INSERT INTO message VALUES (202,NULL,«redacted»700120000000000,1,0,0,0,'GUID-202',NULL,0,NULL,NULL);
             -- a tapback (Loved) on message 100 from the device owner; not a message.
             INSERT INTO message VALUES (300,NULL,«redacted»692900000000000,0,0,0,0,'GUID-300','p:0/GUID-100',2000,NULL,NULL);
