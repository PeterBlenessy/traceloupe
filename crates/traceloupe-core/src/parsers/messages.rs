    ...
    fn make_sms_db(dir: &Path) -> std::path::PathBuf {
        ...
        conn.execute_batch(
            "CREATE TABLE handle (ROWID INTEGER PRIMARY KEY, id TEXT);
             ...
             INSERT INTO message VALUES (100,'hey there',«redacted»692800000000000,1,0);
             INSERT INTO message VALUES (101,'hi back',«redacted»692860000000000,0,0);
             INSERT INTO message VALUES (200,'who is in?',«redacted»700000000000000,2,0);
             -- an attachment-only message (NULL text) is kept.
             INSERT INTO message VALUES (201,NULL,«redacted»700060000000000,0,1);
             -- a pure action item (NULL text, no attachment) is skipped.
             INSERT INTO message VALUES (202,NULL,«redacted»700120000000000,1,0);
