    ...
    fn native_messages_from_a_plaintext_backup() {
        ...
        sms.execute_batch(
            "CREATE TABLE handle (ROWID INTEGER PRIMARY KEY, id TEXT);
             ...
             INSERT INTO message VALUES (100,'hi',«redacted»692800000000000,1,0,0,0,'G100',NULL,0,NULL);
    ...
    fn native_messages_resolves_attachments() {
        ...
        sms.execute_batch(
            "CREATE TABLE handle (ROWID INTEGER PRIMARY KEY, id TEXT);
             ...
             INSERT INTO message VALUES (100,NULL,«redacted»692800000000000,1,1,0,0,'G100',NULL,0,NULL);
             INSERT INTO chat_message_join VALUES («redacted»);
