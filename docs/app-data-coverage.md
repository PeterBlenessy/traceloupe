...
|--------|:---:|-------|:---:|-------|
| **Health** | ✅ real | `healthdb_secure.sqlite` 87 MB; «redacted» quantity samples, «redacted» workouts | ★★★ | steps/HR/sleep/workouts + GPS routes (`location_series`). Richest untouched store |
